      ...
      <div className="flex flex-col items-center px-6 py-10 md:px-12">
        <div className="flex flex-col md:flex-row items-center md:space-x-8 mb-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mt-4 md:mt-0">
            ...
            <p className="text-[#D4AF37] text-sm md:text-base">
              Arch user (if you didn't know, he will tell you). Only member of
              the team who knows what he's doing. He's the one who made the
              whole backend. Hatsune Miku enjoyer. Laravel hater.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center md:space-x-8 mb-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mt-4 md:mt-0">
            ...
            <p className="text-[#D4AF37] text-sm md:text-base">
              Certified gym rat, gambler at heart and petrol enjoyer.
              Professional hater of rainbow users and fridges on wheels.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-8 mb-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mt-4 md:mt-0">
            ...
            <p className="text-[#D4AF37] text-sm md:text-base">
              Stock investor (portfolio is -20 % at the moment). Rich experience
              in gambling makes him a valuable member of the Risk Realm team. He
              likes web development too, i guess.
            </p>
          </div>
        </div>
      </div>
