    ...
    <div className="flex flex-col items-center">
      <header className="h-20 bg-[#151520] shadow-lg flex items-center w-full justify-between px-2 md:px-6">
          ...
          <div className="h-full">
            <button 
              type="button"
              className="h-full text-black font-semibold py-1 px-3 md:px-4 cursor-pointer"
            >
        ...
        <h1
          className={`${luckiestGuy.className} text-6xl md:text-8xl font-extrabold text-[#bd78fe] drop-shadow-[0_0_5px_#bd78fe] mb-4 pt-6 md:pt-10`}>Welcome back, Player!</h1>
          <p
          ...
          <div className="mt-6 md:mt-10 w-full px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 h-150">
              ...
              <div className="bg-[#18181b] border border-[#28282b] px-2 py-24 md:px-6 text-[#b090b5] rounded-xl shadow-lg hover:scale-105 hover:shadow-[0px_0px_14px_#ce9aff] transition transform cursor-pointer text-center">
                <h3 className="text-lg md:text-2xl font-bold text-[#be89ff] mb-2">idk yet</h3>
                <p className="text-gray-300 text-sm md:text-base">ignore this for now</p>
              </div>
